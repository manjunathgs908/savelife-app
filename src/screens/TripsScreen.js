        ...
        {HISTORY.map((h) => (
          <View key={h.id} style={styles.card}>
            ...
            <Text style={styles.route}>
              <Text style={{ color: "rgba(0,0,0,0.3)" }}>● </Text>{h.from}{"\n"}
...
const styles = StyleSheet.create({
  ...
  header: { color: COLORS.text, fontSize: 22, fontWeight: "800", paddingHorizontal: 22, paddingBottom: 18 },
  ...
  type: { color: COLORS.text, fontWeight: "700", fontSize: 14 },
  ...
  footer: { flexDirection: "row", justifyContent: "space-between", alignItems: "center", marginTop: 12, paddingTop: 12, borderTopWidth: 1, borderTopColor: "rgba(0,0,0,0.06)" },
