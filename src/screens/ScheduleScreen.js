...
const styles = StyleSheet.create({
  ...
  fareAmt: { color: COLORS.white, fontSize: 14, fontWeight: "700" },
  ...
  dayPill: { width: 44, alignItems: "center", paddingVertical: 9, borderRadius: 10, borderWidth: 0.5, borderColor: "rgba(255,255,255,0.1)", backgroundColor: "rgba(255,255,255,0.04)" },

  // Month day grid
  monthGrid: { flexDirection: "row", flexWrap: "wrap", gap: 6, marginBottom: 4 },
  monthDayChip: { width: 40, height: 38, alignItems: "center", justifyContent: "center", borderRadius: 8, borderWidth: 0.5, borderColor: "rgba(255,255,255,0.1)", backgroundColor: "rgba(255,255,255,0.04)" },
  ...
  // Time picker
  timeDivider: { height: 0.5, backgroundColor: "rgba(255,255,255,0.08)", marginVertical: 16 },
  ...
  // Patient switches
  serviceCard: { backgroundColor: "rgba(255,255,255,0.04)", borderWidth: 0.5, borderColor: "rgba(255,255,255,0.08)", borderRadius: 14, padding: 16, marginTop: 8 },
