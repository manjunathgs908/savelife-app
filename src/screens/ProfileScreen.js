      ...
      <ScrollView contentContainerStyle={{ padding: 18 }}>
        ...
        <View style={styles.brandFooter}>
          <Text style={styles.brandText}>
            ...
            <Text style={{ color: "rgba(255,255,255,0.7)" }}>Life</Text> 🚑
          </Text>
...
const styles = StyleSheet.create({
  ...
  header: { color: COLORS.white, fontSize: 22, fontWeight: "800", paddingHorizontal: 22, paddingBottom: 10 },
  ...
  addrIcon: { width: 42, height: 42, borderRadius: 11, backgroundColor: "rgba(255,255,255,0.05)", alignItems: "center", justifyContent: "center" },
  addrLabel: { color: COLORS.white, fontWeight: "600", fontSize: 14 },
  addrText: { color: COLORS.grayDim, fontSize: 11, marginTop: 2 },
  row: { flexDirection: "row", alignItems: "center", gap: 14, paddingVertical: 14, paddingHorizontal: 4, borderBottomWidth: 1, borderBottomColor: "rgba(255,255,255,0.05)" },
  rowText: { flex: 1, color: "rgba(255,255,255,0.8)", fontSize: 14 },
