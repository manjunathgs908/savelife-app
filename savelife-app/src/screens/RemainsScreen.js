  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.center}>
        ...
        <Text style={styles.title}>Dead Body Transport</Text>
        <Text style={styles.subtitle}>Coming Soon</Text>
        <Text style={styles.message}>
          We are working on this dignified service.{"\n"}Stay tuned!
        </Text>
      </View>
...
const styles = StyleSheet.create({
  ...
  iconBox: { width: 100, height: 100, borderRadius: 28, backgroundColor: "rgba(232,25,44,0.1)", borderWidth: 0.5, borderColor: "rgba(232,25,44,0.3)", alignItems: "center", justifyContent: "center", marginBottom: 24 },
  icon: { fontSize: 46 },
