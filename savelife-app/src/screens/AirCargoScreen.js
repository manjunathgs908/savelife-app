...
export default function AirCargoScreen({ navigation }) {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <View>
          <Text style={styles.headerTitle}>Air Cargo Transport</Text>
          <Text style={styles.headerSub}>Reliable air cargo & body shifting service</Text>
        </View>
      </View>
      ...
      >
        ...
        <View style={styles.banner}>
          ...
          <View style={{ flex: 1 }}>
            <Text style={styles.bannerTitle}>Reliable air cargo & body shifting, domestic & international</Text>
            <Text style={styles.bannerBadge}>● 24×7 dedicated service</Text>
          </View>
        </View>
        ...
        <TouchableOpacity style={styles.submitBtn} onPress={handleSubmit} activeOpacity={0.85}>
          <Text style={styles.submitBtnText}>✈️  Request Air Cargo Transport</Text>
        </TouchableOpacity>
